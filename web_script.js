...
function init() {
  ...
  document.getElementById('page_icon_setup').addEventListener('click', function() { select_page('setup'); });
  ...
  document.getElementById('number_D2').addEventListener('change', function() { modbus_set_D(2,parseInt(this.value, 10)); });
  document.getElementById('number_D3').addEventListener('change', function() { modbus_set_D(3,parseInt(this.value, 10)); });

  document.getElementById('button_R2.1').addEventListener('click', function() { modbus_set_R(2, 1); });
  document.getElementById('button_R2.2').addEventListener('click', function() { modbus_set_R(2, 2); });
  document.getElementById('button_R3.1').addEventListener('click', function() { modbus_set_R(3, 1); });
  document.getElementById('button_R3.2').addEventListener('click', function() { modbus_set_R(3, 2); });
...
function update_values(res) {
  ...
  if (res < 0) {
    ...
    document.getElementById('value_D3').textContent = "-";
    document.getElementById('value_D2').textContent = "-";
    ws_toggle(document.getElementById("button_R1.2"), 0);
    ws_toggle(document.getElementById("button_R1.1"), 0);
    ws_toggle(document.getElementById('label_D4.23'), 0);
    ws_toggle(document.getElementById('label_D4.01'), 0);
    option_revert(0);
  }
  else {
    tablink = document.getElementsByClassName("tablink");
    document.getElementById('value_D0').textContent = tablink[modbus_get_D(0)].textContent;
    document.getElementById('value_D3').textContent = modbus_get_D(3);
    document.getElementById('value_D2').textContent = modbus_get_D(2);
    ...
    ws_toggle(document.getElementById('label_D4.23'), (modbus_get_D(4) & 12) === 12);
    ws_toggle(document.getElementById('label_D4.01'), (modbus_get_D(4) & 3) === 3);
